...
- (void)configureView
{
    ...
    if (self.restriction)
    {
        ...
        if (numberOfSigns > 0)
        {
            self.arrayLabel.text = [NSString stringWithFormat:@"%lu parking signs on this street. Zoom in to view them.", (unsigned long)self.restriction.clusterRestriction.count];
        } else
        {
